1. Write a unix shell script to read a text file which contains some data(around 5 lines of data) and loop through it and put that data back into a shell script array
